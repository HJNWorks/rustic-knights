...
- Start: `Chess.default()`, or `?fen=` consumed once when `GameView` mounts
...
Unchanged adapter. Phase 2 feeds FEN to Stockfish. Phase 4 validates UCI on the server with `shakmaty`.
